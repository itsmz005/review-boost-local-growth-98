...
const TestimonialsSection = () => {
  const testimonials = [
    ...
    },
    {
      ...
      name: "David T.",
      role: "Owner, T******* Plumbing Services",
    ...
    },
    {
      ...
      name: "Jennifer W.",
      role: "Realtor, W**** Real Estate Group",
